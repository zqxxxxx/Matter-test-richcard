...
export type MittEvents = {
  ...
  "wk:toggle-matter-panel": { channelId: string; channelType: number; matterId?: string; forceOpen?: boolean };
  ...
  "wk:toggle-summary-panel": { channelId: string; channelType: number; summaryPanelView: 'history' | 'new'; taskId?: number; forceOpen?: boolean };
